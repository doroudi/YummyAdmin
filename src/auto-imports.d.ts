...
declare global {
  ...
  const useAccountStore: typeof import('./store/account')['useAccountStore']
  ...
  const useBrandStore: typeof import('./store/brand')['useBrandStore']
  ...
  const useNotifyStore: typeof import('./store/notify')['useNotifyStore']
