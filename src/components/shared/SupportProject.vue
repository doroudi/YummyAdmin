...
<template>
  <div class="support-button ltr font-">
    <button href="https://github.com/doroudi/yummyadmin" target="_blank"
      ...
      <div class="flex items-center">
        ...
        <span class="ms-1 text-white">Star on GitHub</span>
      </div>
      <div class="ml-2 flex items-center gap-1 text-sm md:flex">
        ...
        <span class="inline-block tabular-nums tracking-wider font-display font-medium text-white">{{ starsCount }}</span>
      </div>
    </button>
  </div>
